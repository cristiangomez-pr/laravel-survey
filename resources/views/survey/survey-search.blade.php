                ...
                <tbody>
                    ...
                    <tr class="odd:bg-white even:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-sky-700 hover:text-sky-600">
                            <a href="{{ route('surveys.edit', $survey['id']) }}"  class="inline-flex items-center">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-normal">
                            <div class="inline-flex items-baseline space-x-2">
                                <div x-data="{ shown: false, timeout: null }"
                                    @clipboard-{{ $survey['id'] }}.window="() => { clearTimeout(timeout); shown = true; timeout = setTimeout(() => { shown = false }, 1500);  }"
                                ...
                                <a @click="clipboard('{{ route('surveys.start', $survey['slug']) }}', '{{ $survey['id'] }}')" class="cursor-pointer inline-flex items-center text-gray-400 hover:text-gray-500">
